...
export function analyzeClimateIntelligence(
  ...
  const priorityAdvisories = [
    ...
    },
    {
      ...
      action: isMr ? "पाने पिवळी पडल्यास किसान सेतू पीक डॉक्टर फोटो स्कॅनरचा वापर करा." : "Use Kisan Setu Crop Doctor photo scanner to capture leaf symptoms at first sign of yellowing or spots."
    },
    {
