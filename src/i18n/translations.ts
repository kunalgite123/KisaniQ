...
export const translations = {
  en: {
    ...
    goverment_schemes: "Government Agriculture Schemes",
    ...
    climate_subtitle: "7-day weather forecast & farm impact analysis for Kopargaon taluka",
  ...
  hi: {
    ...
    nav_crop: "फसल डॉक्टर",
    nav_climate: "मौसम एवं जलवायु",
    nav_water: "जल एवं मृदा",
    nav_machinery: "श्रम और मशीनरी",
    nav_schemes: "सरकारी योजनाएं",
    nav_advisory: "कृषि परामर्श",
    nav_impact: "प्रभाव तुलना",
    nav_trust: "सूचना सत्यापन",
    nav_market: "मंडी भाव",

    nav_desc_dashboard: "खेत का अवलोकन और आज की मुख्य जानकारी",
    nav_desc_crop: "फसल स्वास्थ्य और रोग निदान तकनीक",
    nav_desc_climate: "मौसम पूर्वानुमान और जोखिम विश्लेषण",
    nav_desc_water: "भूजल स्तर और मिट्टी स्वास्थ्य जांच",
    nav_desc_machinery: "कृषि उपकरण और मजदूर किराए पर लें",
    nav_desc_schemes: "सरकारी कृषि योजनाएं एवं सब्सिडी",
    nav_desc_advisory: "एआई-संचालित कृषि सिफारिशें",
    nav_desc_impact: "पारंपरिक खेती बनाम कृषि सेतु एआई प्रभाव",
    nav_desc_trust: "कार्रवाई करने से पहले कृषि जानकारी सत्यापित करें",
    nav_desc_market: "लाइव एपीएमसी मंडी बाजार दरें और भाव",

    // Titles & Breadcrumbs
    title_dashboard: "डैशबोर्ड अवलोकन",
    title_crop: "फसल डॉक्टर (रोग निदान)",
    title_climate: "मौसम और जलवायु जोखिम",
    title_water: "जल एवं मृदा बुद्धिमत्ता",
    title_machinery: "श्रम और मशीनरी निगरानी",
    title_schemes: "सरकारी योजनाएं",
    title_advisory: "एआई कृषि परामर्श",
    title_impact: "कृषि सेतु प्रभाव तुलना",
    title_trust: "सूचना सत्यापन",

    // Top Navbar & Controls
    location_label: "कोपरगांव (तालुका केंद्र)",
    live_data: "लाइव डेटा",
    systems_operational: "प्रणालियां क्रियाशील",
    main_navigation: "मुख्य नेविगेशन",
    farm_location: "खेत की स्थिति",
    district_name: "अहिल्यानगर, महाराष्ट्र",
    system_status_online: "कृषि सेतु एआई ऑनलाइन",
    all_systems_ok: "सभी प्रणालियां क्रियाशील हैं",

    // Voice Assistant i18n Keys
    voice_listening: "सुन रहे हैं... स्वाभाविक रूप से बोलें",
    voice_processing: "आपके प्रश्न को समझा जा रहा है...",
    voice_speaking: "कृषि सेतु एआई बोल रहा है...",
    voice_unsupported: "इस ब्राउज़र में वॉयस इनपुट समर्थित नहीं है।",
    voice_error_try_again: "आवाज़ नहीं समझ सके। कृपया पुन: प्रयास करें।",
    voice_navigating_to: "नेविगेट किया जा रहा है",

    // Dashboard Greeting & Score
    greeting_good_morning: "शुभ प्रभात 👋",
    greeting_intelligence_sub: "आज की आपकी कृषि बुद्धिमत्ता • ",
    maharashtra: "महाराष्ट्र",
    signal_climate: "जलवायु",
    signal_water: "जल",
    signal_crop_ai: "फसल एआई",
    signal_monitored: "निगरानी की गई",
    signal_scouted: "जांच की गई",
    status_optimal: "उत्कृष्ट",
    status_moderate: "मध्यम",
    status_action_required: "कार्रवाई आवश्यक",
    status_critical: "गंभीर",
    status_monitor: "निगरानी करें",
    status_stable: "स्थिर",
    confidence: "विश्वास स्तर",
    timeframe_label: "समय-सीमा: 24–48 घंटे",
    view_full_advisory: "पूर्ण परामर्श विवरण देखें →",
    why_recommending: "हम इसकी सिफारिश क्यों कर रहे हैं?",
    show_reasoning: "▼ एआई तर्क दिखाएं",
    hide_reasoning: "▲ तर्क छिपाएं",
    todays_farm_decision: "आज का कृषि निर्णय · कृषि सेतु एआई विश्लेषण",

    // Flow Node Labels
    node_climate: "मौसम",
    node_soil: "मृदा",
    node_groundwater: "भूजल",
    node_crop_ai: "फसल एआई",
    node_krishi_ai: "कृषि सेतु एआई",
    soil_black_murrum: "काली / मुर्रम",
    taluka_baseline: "तालुका बेसलाइन",
    canal_reach: "नहर क्षेत्र",
    well_depleted: "कुआं जलस्तर कम",
    leaf_scout: "पत्ती जांच",

    // Verdict Titles
    act_this_week: "इस सप्ताह कार्रवाई करें",
    monitor_closely: "गहन निगरानी रखें",
    conditions_stable: "स्थितियां स्थिर हैं",

    // Section Labels in Dashboard
    climate_intelligence: "जलवायु बुद्धिमत्ता",
    weather_dry_spell: "मौसम और शुष्क अवधि जोखिम",
    view_7day_forecast: "7-दिवसीय पूर्वानुमान देखें →",
    crop_intelligence: "फसल बुद्धिमत्ता",
    pest_disease_diag: "कीट एवं रोग निदान",
    no_disease_logged: "कोई रोग दर्ज नहीं हुआ",
    water_soil_intel: "जल और मृदा बुद्धिमत्ता",
    groundwater_depletion: "भूजल और मिट्टी की नमी",
    view_water_model: "जल स्तर मॉडल देखें →",
    labour_equipment: "श्रम और मशीनरी",
    custom_hiring_rates: "कस्टम हायरिंग और दैनिक दरें",
    explore_machinery: "मशीनरी देखें →",
    schemes_subsidies: "सरकारी योजनाएं और सब्सिडी",
    eligible_programmes: "पात्र राज्य और केंद्रीय कार्यक्रम",
    view_matched_schemes: "मिलान की गई योजनाएं देखें →",
    advisory_recommendations: "कृषि सेतु परामर्श सिफारिशें",
    ai_actions_today: "आज के लिए एआई कार्रवाई प्राथमिकताएं",
    open_advisory_page: "परामर्श पृष्ठ खोलें →",

    // Crop Health Page
    upload_leaf_title: "पत्ती का फोटो अपलोड करें",
    drag_drop_text: "यहां फोटो ड्रैग करें या फाइल चुनें",
    supported_crops_label: "समर्थित फसलें: कपास, गन्ना, प्याज",
    analyzing_image: "चित्र का विश्लेषण किया जा रहा है...",
    ...
    organic_control: "जैविक / सांस्कृतिक नियंत्रण",
    upload_new_image: "नई फोटो अपलोड करें",
    sample_scenarios: "नमूना परिदृश्य आजमाएं:",
    sample_cotton_blight: "कपास जीवाणु झुलसा",
    sample_sugarcane_redrot: "गन्ना लाल सड़न",
    sample_onion_blotch: "प्याज बैगनी धब्बा",

    // Water & Soil Page
    water_table_depth: "भूजल स्तर की गहराई",
    soil_moisture_level: "मिट्टी की नमी का स्तर",
    aquifer_status: "एक्विफर स्थिति",
    irrigation_advice: "सिंचाई सलाह",
    soil_health_card: "मृदा स्वास्थ्य कार्ड (कोपरगांव तालुका)",
    ...
    recommended_fertilizer: "अनुशंसित उर्वरक खुराक",
    water_conservation_tip: "जल संरक्षण सुझाव",
    ...
    dry_spell_risk: "शुष्क अवधि जोखिम सूचकांक",
    heatwave_warning: "लू की चेतावनी",
    forecast_7day: "7-दिवसीय मौसम पूर्वानुमान",
    dry_spell_explanation: "शुष्क अवधि जोखिम का अर्थ और गणना कैसे की जाती है",

    // Schemes Page
    personalized_gov_support: "आपकी स्थिति के आधार पर व्यक्तिगत सरकारी सहायता",
    matched_against_desc: "आपकी फसल, तालुका स्थिति और मौसम के आधार पर फ़िल्टर की गई योजनाएं.",
    search_schemes_placeholder: "योजनाएं खोजें (जैसे: पीएम-किसान, ठिबक, फसल बीमा)...",
    all_schemes_chip: "सभी योजनाएं",
    income_support_tag: "आय सहायता",
    crop_insurance_tag: "फसल बीमा",
    irrigation_tag: "सिंचाई एवं ठिबक",
    soil_health_tag: "मृदा स्वास्थ्य",
    market_access_tag: "बाजार पहुंच",
    high_relevance_label: "उच्च प्राथमिकता",
    good_match_label: "उपयुक्त योजना",
    relevant_label: "प्रासंगिक योजना",
    view_detailed_summary: "विस्तृत विवरण देखें",
    official_website: "आधिकारिक वेबसाइट",
    gov_disclaimer_notice: "अस्वीकरण: जानकारी आधिकारिक केंद्र और राज्य सरकार की वेबसाइटों (MahaDBT, PM-KISAN, PMFBY) से ली गई है। आवेदन करने से पहले आधिकारिक पोर्टल पर पुष्टि करें।",
    farm_scheme_matching_label: "खेत योजना मिलान",
    active_schemes_stat: "सक्रिय योजनाएं",
    categories_stat: "श्रेणियां",
    gov_portal_catalog_label: "सरकारी पोर्टल सूची",
    explore_all_schemes: "सभी सरकारी योजनाएं देखें",

    // Machinery Page
    list_machine_btn: "➕ अपना उपकरण या मजदूर दल दर्ज करें",
    rent_machine_btn: "🚜 किराए पर लें",
    call_owner_btn: "📞 कॉल करें",
    all_categories: "सभी",
    tractors: "🚜 ट्रैक्टर",
    harvesters: "🌾 हार्वेस्टर",
    implements: "⚙️ उपकरण",
    sprayers: "💨 स्प्रेयर",
    labour_crews: "👨‍🌾 मजदूर दल",
    available_now: "वर्तमान में उपलब्ध",
    per_hour: "प्रति घंटा",
    per_day: "प्रति दिन",
    per_acre: "प्रति एकड़",
    total_listed: "कुल पंजीकृत मशीनरी",
    across_villages: "कोपरगांव तालुका के गांवों के अनुसार",
    ready_dispatch: "खेत में कार्य हेतु तैयार",
    heavy_units: "भारी मशीनरी",
    sugarcane_grain_harvesters: "गन्ना और अनाज हार्वेस्टर",
    cutting_sowing_teams: "कटाई, छिड़काव और बुवाई दल",

    // Advisory Page
    gov_schemes_title: "सरकारी कृषि योजनाएं",
    pm_kisan_title: "पीएम-किसान सम्मान निधि",
    drip_subsidy_title: "ड्रिप सिंचाई सब्सिडी (MUKRIS)",
    crop_insurance_title: "प्रधानमंत्री फसल बीमा योजना (PMFBY)"
  }
};
