...
export const translations = {
  en: {
    ...
    system_status_online: "Kisan Sarthi AI Online",
    ...
    voice_speaking: "Kisan Sarthi AI is speaking...",
    ...
    todays_farm_decision: "TODAY'S FARM DECISION · Kisan Sarthi AI Convergence",
    ...
    node_krishi_ai: "Kisan Sarthi AI",
    ...
    action_schedule_label: "KISAN SARTHI AI ENGINE OUTPUT · ACTION SCHEDULE",
    ...
    why_recommends_btn: "Why Kisan Sarthi recommends this ▼",
    ...
    edge_privacy_notice: "🔒 Kisan Sarthi Edge Privacy: Neural networks run 100% locally inside your web browser via TensorFlow.js — no leaf photos leave your device.",
  ...
  mr: {
    ...
    todays_farm_decision: "आजचा शेती निर्णय · किसान सारथी एआय निष्कर्ष",
    ...
    node_krishi_ai: "किसान सारथी एआय",
    ...
    action_schedule_label: "किसान सारथी एआय इंजिन निष्कर्ष · कृती वेळापत्रक",
    ...
    why_recommends_btn: "किसान सारथी ही शिफारस का करतो ▼",
    ...
    edge_privacy_notice: "🔒 किसान सारथी गोपनीयता: तुमचे फोटो मोबाईलवरच तपासले जातात — कोणतेही फोटो बाहेर जात नाहीत.",
